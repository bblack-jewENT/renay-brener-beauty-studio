...
export const SERVICES: Service[] = [
  {
    ...
    description:
      "Tension-free, natural-looking braids customized to your length and size preference.",
    price: "from R180",
    duration: "4-6 hours",
  ...
  },
  {
    ...
    title: "Fulani Style",
    description:
      "Intricate cornrow designs mixed with box braids, adorned with beads if desired.",
    price: "from R200",
    duration: "5 hours",
  ...
  },
  {
    ...
    description:
      "High-end nail extensions with hand-painted nail art and precision shaping.",
    price: "from R85",
    duration: "2 hours",
  ...
  },
  {
    ...
    description:
      "Soft gel extension system for a lightweight, natural feel and maximum durability.",
    price: "from R75",
    duration: "1.5 hours",
  ...
  },
  {
    ...
    description:
      "Multiple lightweight extensions applied to each natural lash for a full, fluffy look.",
    price: "from R150",
    duration: "2.5 hours",
  ...
  },
  {
    ...
    description:
      "A perfect blend of classic and volume for a textured, everyday glam appearance.",
    price: "from R130",
    duration: "2 hours",
